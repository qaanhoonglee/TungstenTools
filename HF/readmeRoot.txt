...
2. Copy the "deliverables\{hotfix-name}.zip" file inside the deliverables folder of PDT tool. The path may look like "PDT-TOOL\deliverables". Make sure only {hotfix-name}.zip file is there and remove all the other files/folders, otherwise PDT tool will install all the hotfixes places inside the deliverables folder.
3. Run cmd as Administrator and navigate to the PDT tool location.
4. Run command "generic_installer{env-extension}" to install the hotfix.
...
1. Copy the "deliverables\{hotfix-name}.zip" file inside the deliverables folder of PDT tool. The path may look like "PDT-TOOL\deliverables". Make sure only {hotfix-name}.zip file is there and remove all the other files/folders, otherwise PDT tool will uninstall all the hotfixes places inside the deliverables folder.
2. Run cmd as Administrator and navigate to the PDT tool location.
3. Run command "generic_uninstaller{env-extension}" to uninstall the hotfix.
