...
namespace FindFile
{
    public partial class Form1 : Form
    {
        ...
        private void btnActiveLicense_Click(object sender, EventArgs e)
        {
            ...
            string filePath = @"C:\LicenseRelease\LicenseRelease\ephesoft-license-generator\META-INF\ephesoft-license-generator\license.info.properties";
            using (StreamWriter writer = new StreamWriter(filePath, false))
            {
                writer.Write(LicenseInfoProperties());
            }
            //Command to execute in CMD
            string command = "ant -f  C:\\LicenseRelease\\LicenseRelease\\ephesoft-license-generator\\run.xml";
            CommandToExecute(txtAnt.Text, command);

            string sourceFilePath = $"{txtAnt.Text}\\ephesoft.lic";
            string destinationFilePath = "C:\\Ephesoft\\Dependencies\\license-util\\ephesoft.lic";

            // Copy the file
            File.Copy(sourceFilePath, destinationFilePath, true);

            command = "install-license.bat";
            CommandToExecute("C:\\Ephesoft\\Dependencies\\license-util", command);
        }
        ...
        private string LicenseInfoProperties()
        {
            ...
            info += "	ephesoft.license.date.not_after=December 30 2030" + Environment.NewLine;
            ...
            info += "	ephesoft.license.server.annualImageCount=10" + Environment.NewLine;
            ...
            var system = cboOperatingSystem.SelectedIndex;
            ...
            info += "	ephesoft.license.icrplus.annualImageCount=9999" + Environment.NewLine;
        ...
        private void btnHfReadme_Click(object sender, EventArgs e)
        {
            hfReadme hfReadme = new();
            hfReadme.Show();
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            foreach (NetworkInterface nic in NetworkInterface.GetAllNetworkInterfaces())
            {
                ...
                if (nic.OperationalStatus == OperationalStatus.Up)
                {
                    ...
                    Console.WriteLine($"MAC Address: {GetMacAddress(nic)}");
                    Console.WriteLine();
